...
void setup(){
    ...
    sensors.push_back(Sensor(sensorid, sharedsecret, "U", "Spannung Solon Modul 7", "[V]", 0.023, &getVoltage)); //Spannung Solon Modul 7
    sensors.push_back(Sensor(sensorid, sharedsecret, "I", "Strom Solon Modul 7", "[A]", 0.026, &getCurrent)); //Strom Solon Modul 7
